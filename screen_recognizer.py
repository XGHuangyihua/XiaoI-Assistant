...
class ScreenRecognizer:
    ...
    def recognize_text_in_region(self, region):
        """
        使用OCR识别指定区域的文字
        ...
        pil_image = Image.fromarray(cv2.cvtColor(screen_region, cv2.COLOR_BGR2RGB))
